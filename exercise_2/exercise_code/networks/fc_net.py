...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3 * 32 * 32, hidden_dim=100, num_classes=10,
        ...
        self.params['b1'] = np.zeros((1, hidden_dim), dtype = np.float32)
        self.params['W2'] = weight_scale * np.random.randn(hidden_dim, num_classes)
        self.params['b2'] = np.zeros((1, num_classes), dtype = np.float32)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
    ...
    def loss(self, X, y=None):
        ...
        H, cacheZ1 = affine_relu_forward(X, self.params['W1'], self.params['b1'])
        scores, cacheZ2  = affine_forward(H, self.params['W2'], self.params['b2'])
        ...
        delta2, grads['W2'], grads['b2'] = affine_backward(delta3, cacheZ2)
        _, grads['W1'], grads['b1'] = affine_relu_backward(delta2, cacheZ1) 
