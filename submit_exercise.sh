...
rsync --delete-before --chmod=Dguo+rwx,Fguo+rw -rlv -e 'ssh -x -p 58022' --exclude '*.pyc' --exclude 'output.*' --exclude '.gitignore' --exclude "__pycache__/" models/ exercise_code $2@filecremers1.informatik.tu-muenchen.de:submit/EX$1/
